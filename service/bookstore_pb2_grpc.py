...
class InventoryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateBook = channel.unary_unary(
            ...
            response_deserializer=bookstore__pb2.CreateBookResponse.FromString,
        )
...
def add_InventoryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "CreateBook": grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=bookstore__pb2.CreateBookResponse.SerializeToString,
        ),
    }
...
class InventoryService(object):
    ...
    def CreateBook(
        ...
        return grpc.experimental.unary_unary(
            ...
            bookstore__pb2.CreateBookResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
